...
from utils.lector_json import leer_datos_json

import time
RUTA_JSON = "datos/productos.json"

@pytest.mark.parametrize("usuario,contraseña",[("standard_user","secret_sauce")])
@pytest.mark.parametrize("nombre_producto",leer_datos_json(RUTA_JSON))
def test_cart_json(login_in_driver,usuario,contraseña,nombre_producto):
    try:
        ...
        assert cartPage.obtener_nombres_items_carrito() == nombre_producto
